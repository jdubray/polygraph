...
const instance = createInstance({ strict: true, hasAsyncActions: false, instanceName: 'order-v2-shape-migrated' });

const INITIAL_STATE = { orderState: 'pending', totalCents: 0, txId: '', trackingId: '' };
  ...
  component: {
    ...
    acceptors: {
      ...
      CANCEL: (model) => (p, { reject, next, unchanged }) => {
        ...
        unchanged('totalCents', 'txId', 'trackingId');
      },
    },
    reactors: [],
  },
