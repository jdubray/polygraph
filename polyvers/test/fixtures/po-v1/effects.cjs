// polyvers M3 matrix fixture — parent effect mapper: entering 'fulfilling'
// spawns one shipment child, completing via CHILD_DONE, cancelled on parent
// terminal via CANCEL_SHIPMENT.
'use strict';
