// polyvers M3 matrix fixture — parent order machine.
// pending → START → fulfilling → CHILD_DONE → completed; CANCEL → cancelled.
'use strict';

const { createInstance } = require('@cognitive-fab/sam-pattern');

const instance = createInstance({ strict: true, hasAsyncActions: false, instanceName: 'po-v1' });
