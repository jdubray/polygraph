...
const instance = createInstance({ strict: true, hasAsyncActions: false, instanceName: 'order-v2-renamed' });
...
const control = instance({
  ...
  component: {
    ...
    actions: {
      ...
      DISPATCH: { action: (d = {}) => ({ ...d }), schema: {}, domain: [{}] },
    ...
    acceptors: {
      ...
      DISPATCH: (model) => (p, { reject, next, unchanged }) => {
