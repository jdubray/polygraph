...
const instance = createInstance({ strict: true, hasAsyncActions: false, instanceName: 'ship-v2-renamed' });
...
const control = instance({
  ...
  component: {
    ...
    actions: {
      ...
      ABORT_SHIPMENT: { action: (d = {}) => ({ ...d }), schema: {}, domain: [{}] },
    },
    acceptors: {
      ...
      ABORT_SHIPMENT: (model) => (p, { reject, next }) => {
