...
export const stateInvariants = [
  {
    // v2: the amendment counter is a non-negative integer (strengthened
    // intent shipped WITH the shape change — invariants move first).
    name: 'amend-count-nonnegative',
    pred: (s) => Number.isInteger(s.amendCount) && s.amendCount >= 0,
  },
  {
