// Positive control: hand-written reference spec of the Order workflow's
...
const instance = createInstance({ strict: true, hasAsyncActions: false, instanceName: 'orderRef' });
