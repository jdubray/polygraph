...
const { created } = rt.create('order', ORDER_ID);
say(created ? 'created order instance' : 'resuming existing order instance');
const submit = rt.dispatch(ORDER_ID, 'SUBMIT', { totalCents: 2500 }, 'submit:cart-42');
...
for (const row of rt.getJournal(ORDER_ID)) {
